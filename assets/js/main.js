...
(function() {
    ...
    if (preloader) {
      window.addEventListener('load', () => {
        setTimeout(() => {
          ...
          setTimeout(() => {
            preloader.remove();
          }, 800); // Duración del efecto de transición de opacidad
        }, 2800); // 2000 milisegundos = 2 segundos
      });
    }
  });
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function toggleButtons() {
      ...
      if (callButton && whatsappButton) {
        window.scrollY > 100 ? callButton.classList.add('active') : callButton.classList.remove('active');
